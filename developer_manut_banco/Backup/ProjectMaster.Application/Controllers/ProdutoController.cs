...
namespace ProjectMaster.Application.Controllers
{
    public class ProdutoController : ControllerMaster
    {
        ...
        private bool ValidaForm(ProdutoModels form)
        {
            ...
            if (form.vl_embalagem == 0)
                ModelState.AddModelError("vl_embalagem", "Campo (Valor Embalagem) é obrigatório.");
        ...
        public JsonResult Lookup(string cprod)
        {
            ...
            return this.Json(
                    new
                    {
                        ...
                        list = (success ? adoProduto.Select(o => new { id_produto = o.id_produto, cprod = o.cprod, xprod = o.xprod }) : null)
                    }, JsonRequestBehavior.AllowGet);
        }
